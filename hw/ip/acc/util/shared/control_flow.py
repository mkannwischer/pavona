...
class ControlGraph:
    '''Represents the control flow graph of (part of) an ACC program.
...
def _populate_control_graph(graph: ControlGraph, program: ACCProgram,
                            start_pc: int,
...
def _label_cycles(program: ACCProgram, graph: ControlGraph, start_pc: int,
...
def _make_control_graph(program: ACCProgram, start_pc: int) -> ControlGraph:
