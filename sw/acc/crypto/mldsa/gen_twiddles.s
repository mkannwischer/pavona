 ...
 * Writes the `scratch` label.  pre: w16={Q,Qinv,..} (R|Q packing), w31=0.
 * preserves x10,x11,x12.  clobbers w0,w17,w24-w30,x5-x7. */
 ...
 * (inv[i]=q-fwd[255-i], shifted tail, two ninv constants).
 * pre: w16={Q,Qinv,..}, w31=0.  preserves x10,x12,w22,w23; leaves MOD=2R|2Q.
 * clobbers w0-w2,w19-w21,w28,w29,x5-x7,x11. */
