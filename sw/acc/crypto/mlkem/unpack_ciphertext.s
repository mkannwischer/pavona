 ...
 * @param[in]  a1: dptr_output, dmem pointer to output polynomial
 ...
 *
 * @param[in]  a0: dptr_input, dmem pointer to input byte array
 * @param[out] a1: dptr_output, dmem pointer to output polynomials
 * @param[in]  a2: k, the security level
 * @param[in]  w16 (sw0): R | Q
 * @param[in]  w31: all-zero register
 *
 ...
 *
 * Description: Subroutine of polyvec_decompress for decompressing 16 coefficients when KYBER_K != 4
 *
 * @param[in/out] w1: input/output vector with 16 16-bit coefficients
 * @param[in]     w16 (sw0): R | Q
